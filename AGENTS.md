...
The current lab recipe uses one M3 Ultra Mac Studio with 256 GB, macOS 27 build `26A428`, an OWC Mercury Helios 5S, a ConnectX-5 Ex MCX516A-CDAT and one DGX Spark connected by a Mellanox MCP1600-C001E30N QSFP28 DAC negotiating 100GBASE-CR4 with RS-FEC, validated 2026-09-15. The pooled headline latency table was measured earlier at 40 Gb/s. The Thunderbolt 5 PCIe tunnel, not the 100 Gb/s port, bounds throughput, and no validated bandwidth figure exists yet. Individual CLI transfers on both links of a two-Spark/one-Studio setup passed on 0.1.18; simultaneous multi-link performance is unmeasured.
